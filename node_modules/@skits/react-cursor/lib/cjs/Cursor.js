...
var Cursor = /** @class */ (function () {
    ...
    Cursor.prototype.animateCursor = function () {
        ...
        var x = (0, utils_1.lerp)(this.cursorCoords.x, this.mouseCoords.x, this.speed);
        var y = (0, utils_1.lerp)(this.cursorCoords.y, this.mouseCoords.y, this.speed);
        ...
        if ((0, utils_1.nearlyEqual)(this.mouseCoords.x, x)) {
            this.isAnimating = false;
            return;
        }
        this.run();
